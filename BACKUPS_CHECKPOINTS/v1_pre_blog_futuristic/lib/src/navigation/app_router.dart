...
import '../features/hr/compliance/screens/compliance_checklist_screen.dart';
...
class AppRouter {
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/hr/compliance_checklist',
        name: 'hr_compliance_checklist',
        builder: (context, state) => const ComplianceChecklistScreen(),
      ),
      GoRoute(
        path: '/pendientes',
        name: 'pendientes',
